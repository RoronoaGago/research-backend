...
from . import views
from .views import DashboardMetricsView, ProtectedView, CustomTokenObtainPairView
...
urlpatterns = [
    ...
    path('reports/sales/export/', views.export_sales_report,
         name='export-sales-report'),
    path('reports/customer-frequency/', views.customer_frequency_report,
         name='customer-frequency-report'),
    path('reports/customer-frequency/export/', views.export_customer_frequency_report,
         name='export-customer-frequency-report'),
    path(
